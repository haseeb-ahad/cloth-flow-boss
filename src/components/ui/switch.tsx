...
>(({ className, ...props }, ref) => (
  <span className="inline-flex items-center justify-center sm:min-w-0 sm:min-h-0 max-[639px]:min-w-[44px] max-[639px]:min-h-[44px] max-[639px]:py-[0.375rem] max-[639px]:px-0">
