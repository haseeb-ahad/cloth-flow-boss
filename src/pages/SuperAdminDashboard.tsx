        ...
        <div className="w-full mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="p-1.5 sm:p-2 rounded-lg sm:rounded-xl bg-gradient-to-br from-cyan-500 to-teal-600 shadow-lg shadow-cyan-500/20">
          ...
          <div className="hidden md:block overflow-x-auto scrollbar-hide">
            <div className="flex justify-center">
              <TabsList className="bg-white/80 backdrop-blur-sm border border-slate-200 p-1 rounded-xl shadow-sm inline-flex flex-wrap h-auto gap-1">
                <TabsTrigger
                  value="dashboard"
                  className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-cyan-500 data-[state=active]:to-teal-600 data-[state=active]:text-white rounded-lg px-4 text-sm whitespace-nowrap"
                >
              ...
              <Card className="border-0 shadow-sm bg-white order-2 lg:order-1">
                <div className="p-4 sm:p-6">
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    <Button
                      variant="outline"
                      className="w-full justify-start h-10 sm:h-12 border-slate-200 hover:bg-cyan-50 hover:border-cyan-200 hover:text-cyan-600 text-sm sm:text-base"
                ...
                <div className="p-4 sm:p-6">
                  <div className="flex items-center justify-between mb-3 sm:mb-4">
                    <h3 className="text-base sm:text-lg font-semibold flex items-center gap-2">
                      <UserPlus className="w-4 h-4 sm:w-5 sm:h-5 text-cyan-500" />
                      Recent Signups
                    </h3>
                      ...
                      {admins.slice(0, 5).map((admin) => (
                        ...
                        >
                          <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-cyan-500 to-teal-600 flex items-center justify-center text-white font-semibold text-xs sm:text-sm flex-shrink-0">
                          ...
                          <Badge className="bg-cyan-100 text-cyan-700 hover:bg-cyan-100 text-xs sm:text-sm ml-2 flex-shrink-0">
